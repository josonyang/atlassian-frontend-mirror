...
const dummyAvatarComponent = <Avatar src={getPersonAvatarUrl('wowowow')} appearance="square" />;
	...
	render(): React.JSX.Element {
		return (
			<div>
				<h3>People</h3>
				<p>
					People results have circular avatar and a name. They can optionally display a mention
					handle and presence.
				</p>
				...
				<ResultItemGroup title="People examples">
					...
					<PersonResult
						...
						presenceState="online"
					/>
					<PersonResult {...defaultProps} key="4" name="Minimum detail person" />
				</ResultItemGroup>
			</div>
		);
	}
