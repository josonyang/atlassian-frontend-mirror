...
const dummyAvatarComponent = <Avatar src={getContainerAvatarUrl(4)} appearance="square" />;
	...
	render(): React.JSX.Element {
		return (
			<div>
				<h3>Containers</h3>
				<p>
					Containers have square avatars, can be marked as private and have a name and subText
					fields.
				</p>
				...
				<ResultItemGroup title="Object examples">
					<ContainerResult
						...
						subText="They're big!"
					/>
					<ContainerResult {...defaultProps} isPrivate name="Private container" />
					<ContainerResult {...defaultProps} key="3" name="Minimum detail container" />
					<ContainerResult
						{...defaultProps}
