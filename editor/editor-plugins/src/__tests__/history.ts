...
describe('history wrapper', () => {
	it('check ./history exports all the same variables as the original', () => {
		const original = require('@atlaskit/editor-plugin-history');
		const wrapper = require('../history/index');
