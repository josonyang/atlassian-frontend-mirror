...
- [#40421](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/40421)
  [`c93a5930f34`](https://bitbucket.org/atlassian/atlassian-frontend/commits/c93a5930f34) - [ux]
  Inserting block nodes will no longer replace the selected content, instead the block node will be
  inserted after it.
