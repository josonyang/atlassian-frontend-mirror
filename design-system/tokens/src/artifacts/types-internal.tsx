...
export type InternalTokenIds =
	...
	| 'color.text.discovery.[default]'
	| 'color.text.discovery.bolder'
	| 'color.text.information.[default]'
	| 'color.text.information.bolder'
	| 'color.text.subtlest'
	| 'color.text.subtle'
	| 'color.link.[default]'
	| 'color.link.pressed'
	| 'color.link.visited.[default]'
	...
	| 'color.background.danger.subtler.[default]'
	...
	| 'color.background.warning.subtler.[default]'
	...
	| 'color.background.success.subtler.[default]'
	...
	| 'color.background.discovery.subtler.[default]'
	...
	| 'color.background.information.subtler.[default]'
