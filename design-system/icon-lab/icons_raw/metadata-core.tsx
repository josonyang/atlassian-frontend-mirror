...
const metadata: IconMetadata = {
	...
	'ai-generative-remix': {
		...
		createdAt: '2026-03-24T21:59:39.190Z',
	},
	...
	'ai-generative-slides': {
		keywords: ['slides', 'AI slides', 'presentation'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Confluence Malleable UI (MaUI)',
		status: 'published',
	...
	'approval-start': {
		keywords: ['approval', 'reapprove', 'approve', 'reapproval'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Confluence Admin',
		status: 'published',
		id: '64705:19827',
		usage: 'Reserved for indicating content that is entering into an approval workflow.',
	...
	'data-lake': {
		...
		createdAt: '2026-04-22T16:08:03.549Z',
	},
	'data-pivot': {
	...
	'deployed-service': {
		keywords: ['deployed service', 'deployment'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
	...
	'dock-toolbar-bottom': {
		keywords: ['dock to bottom', 'fix to bottom', 'pin to bottom'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor design',
		status: 'published',
		id: '64712:34336',
		usage: 'Reserved for docking a toolbar to the bottom of a page.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'dock-toolbar-top': {
	...
	'dock-window-bottom-left': {
		keywords: ['dock to bottom left', 'fix to bottom left', 'pin to bottom left'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor design',
		status: 'published',
	...
	'dock-window-bottom-right': {
		keywords: ['dock to bottom right', 'fix to bottom right', 'pin to bottom right'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor design',
		status: 'published',
	...
	'file-markdown': {
		keywords: ['md', 'markdown', 'document', 'file', 'paper'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Confluence',
		status: 'published',
	...
	'file-text': {
		keywords: ['text file', 'text document', 'paper'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Design System Team',
		status: 'published',
	...
	'hardware-audit': {
		keywords: ['screen', 'display', 'hardware', 'audit', 'audited', 'checklist'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
	...
	'hardware-configuration': {
		keywords: ['screen', 'display', 'hardware', 'configuration', 'settings', 'cog'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:20613',
		usage: 'Reserved for representing hardware configuration.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-defect': {
		keywords: ['screen', 'display', 'hardware', 'damaged', 'defective', 'broken'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:19547',
		usage: 'Reserved for representing defective or damaged hardware.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-dispose': {
		keywords: ['screen', 'display', 'hardware', 'dispose', 'disposal', 'end of life', 'cross'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:24058',
		usage: 'Reserved for representing disposed hardware.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-fulfil': {
		keywords: [
	...
	'hardware-new': {
		keywords: ['screen', 'display', 'hardware', 'add', 'new', 'plus'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64690:19512',
		usage: 'Reserved for representing new hardware.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-procure': {
		keywords: [
		...
		status: 'published',
		id: '64691:23051',
		usage: 'Reserved for representing procured hardware.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-refresh': {
		keywords: ['screen', 'display', 'hardware', 'refresh'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:21090',
		usage: 'Reserved for representing refreshed hardware.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-repair': {
		keywords: ['screen', 'display', 'hardware', 'repair', 'fix', 'wrench'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:20083',
		usage: 'Reserved for representing hardware repair.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-return': {
		keywords: ['screen', 'display', 'hardware', 'return', 'returned'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:22044',
		usage: 'Reserved for representing returned hardware.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-ship': {
		keywords: ['screen', 'display', 'hardware', 'ship', 'shipping', 'shipped', 'arrow up right'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64691:21567',
		usage: 'Reserved for representing shipped hardware',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'hardware-transfer': {
		keywords: ['screen', 'display', 'hardware', 'transfer', 'transferred', 'change ownership'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
	...
	hierarchy: {
		keywords: ['hierarchy', 'heirarchy', 'hierachy', 'relationship', 'tree'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Transformation',
		status: 'published',
	...
	'person-assignee': {
		keywords: ['person', 'assigned to me', 'assignee'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		...
		createdAt: '2026-04-01T23:21:36.600Z',
	},
	'person-lock-locked': {
		keywords: ['person', 'permissions', 'locked', 'restricted access'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64484:20580',
		usage: 'Reserved for restricted user permissions or access.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'person-lock-unlocked': {
		keywords: ['person', 'permissions', 'unlocked', 'unrestricted access'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		id: '64484:21318',
		usage: 'Reserved for unrestricted user permissions or access.',
		createdAt: '2026-03-12T03:59:40.623Z',
	},
	'person-voiceover': {
	...
	'video-timeline-clip-insert-end': {
		keywords: ['video', 'clip', 'timeline', 'end'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Loom',
		status: 'published',
	...
	'video-timeline-clip-insert-playhead': {
		keywords: ['video', 'clip', 'timeline', 'playhead', 'current position'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Loom',
		status: 'published',
	...
	'video-timeline-clip-insert-start': {
		keywords: ['video', 'clip', 'timeline', 'start', 'beginning'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Loom',
		status: 'published',
	...
	'view-split': {
		keywords: ['2 col', 'two columns', 'split view', 'side-by-side', 'layout'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Confluence',
		status: 'published',
