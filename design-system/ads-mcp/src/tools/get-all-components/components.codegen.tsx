 ...
 *
 * @codegen <<SignedSource::a3526860f680965a6cd48e6f9b852f5d>>
...
export const components: ComponentMcpPayload[] = [
	...
	},
	{
		...
		props: [
			...
			{
				name: 'size',
				type: '"small" | "xsmall" | "UNSAFE_xsmall" | "medium" | "large" | "xlarge" | "xxlarge"',
				description:
	...
	},
	{
		...
		props: [
			...
			},
			{
				...
				type: '"var(--ds-avatar-enter)" | "var(--ds-avatar-exit)" | "var(--ds-avatar-hovered)" | "var(--ds-blanket-enter)" | "var(--ds-blanket-exit)" | "var(--ds-button-hovered)" | "var(--ds-button-pressed)" | ... 19 more ... | "var(--ds-spotlight-exit)"',
