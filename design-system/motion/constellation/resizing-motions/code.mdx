...
order: 1
props:
  packageName: '@atlaskit/motion/resizing'
  exports:
    - Resizing
---
...
This hook will animate `width`, `height`, or both dimensions simultaneously as
content changes. Pass the returned `ref` to the element you want to animate.

<TSMorphProps exportName="Resizing" packageName="@atlaskit/motion/resizing" />
...
[useResizing](/components/motion/resizing-motions/code#useresizing) under-the-hood. Its
