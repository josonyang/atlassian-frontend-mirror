...
<Example
	...
	Component={MotionResizingWidth}
	title="Resizing width"
/>
...
<SectionMessage appearance="warning" title="Caution">
	We are planning on deprecating useResizingHeight. Please use the <Link href="#useresizing">useResizing</Link> hook instead.
</SectionMessage>
