...
export function isAllowListedVariable({
	...
	return definitions.every((definition) => {
		...
		return typeof packageName === 'string' && allowList[packageName]?.includes(importName);
	});
}
 ...
 */
function collectEntries(entries: [packageName: string, importName: string][]): AllowList {
