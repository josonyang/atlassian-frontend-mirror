...
export const ParagraphElements = {
	...
	_check(node: JSXElement & { parent: Rule.Node }, { context, config }: MetaData): CheckResult {
	...
	_fixMultiple(
		...
		return (fixer) => {
			...
			return [importFix, ...siblingFixes, wrapperOpenElementFix, wrapperCloseElementFix].filter(
