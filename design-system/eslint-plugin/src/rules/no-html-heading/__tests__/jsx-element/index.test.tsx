...
ruleTester.run('no-html-heading', rule, {
	...
	invalid: [
		...
		{
			code: linesOnly`
				// JSX Element > existing Heading subpath import with different name
				import CustomHeading from '@atlaskit/heading/heading';
				<h3>Hello, World!</h3>
			`,
			errors: [
				{
					...
					suggestions: [
						{
							...
							output: linesOnly`
						// Existing Heading import with same name from another package
						import Heading1 from '@atlaskit/heading/heading';
						import Heading from 'another-package';
					...
					suggestions: [
						{
							...
							output: linesOnly`
						// Existing Heading, Heading1, and Heading2 imports
						import Heading3 from '@atlaskit/heading/heading';
						import Heading from 'another-package';
						import Heading1 from 'yet-another-package';
						import Heading2 from '@some/package';
