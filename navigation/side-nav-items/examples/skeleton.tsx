					...
					<MenuList>
						{menuItemsVisible ? (
							<>
								...
								<FlyoutMenuItem
									onOpenChange={handleRecentFlyoutOpenChange}
									isDefaultOpen={recentFlyoutDefaultOpen}
								>
								...
								<FlyoutMenuItem
									onOpenChange={handleStarredFlyoutOpenChange}
									isDefaultOpen={starredFlyoutDefaultOpen}
								>
									<FlyoutMenuItemTrigger
